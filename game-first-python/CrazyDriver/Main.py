...
IMG_PLAYER = pygame.transform.scale(IMG_PLAYER, (120,120))
...
size = [0.25,0.25,0.25,0.1]
for i in range(len(IMG_ENEMIES)):
    ext = IMG_ENEMIES[i].get_rect()[2:4]
    IMG_ENEMIES[i] = pygame.transform.scale(IMG_ENEMIES[i], (int(ext[0]*size[i]), int(ext[1]*size[i])))
